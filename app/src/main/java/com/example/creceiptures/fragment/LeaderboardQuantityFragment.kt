...
class LeaderboardQuantityFragment(context: Context) : Fragment() {
    ...
    private class ListAdapter(context: Context, resource: Int, private val list: ArrayList<UserInLeaderboard>) :
        ...
        override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
            ...
            val rowView = inflater.inflate(R.layout.leaderboard_quantity_list_item, parent, false)
            ...
            (rowView.findViewById(R.id.num_pets) as TextView).text = user.numPets.toString()
